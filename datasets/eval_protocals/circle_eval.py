...
class Params:
    ...
    def setDetParams(self):
        ...
        self.iouThrs = np.linspace(.5, 0.95, int(np.round((0.95 - .5) / .05)) + 1, endpoint=True)#change to 0.99,origin0.95
        self.recThrs = np.linspace(.5, 1.00, int(np.round((1.00 - .0) / .01)) + 1, endpoint=True)
