...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='mou_glo',
    ...
    ########### add for circle fusion #################################################
    self.parser.add_argument('--load_model_dir', default='',
                             help='path to pretrained model dictionary.')
    ...
    self.parser.add_argument('--target_dir', default='',
                             help='testing and validation study name')
    ...
    #circle fusion
    self.parser.add_argument('--circle_fusion', action='store_true',
                             help='fuse detection result from multiple model.')
    self.parser.add_argument('--circle_fusion_eval', action='store_true',
                             help='fuse detection result evaluation.')
    #ground truth dictionary for circle fusion evaluation
    self.parser.add_argument('--gt_dir', default='',
                             help='ground truth dictionary for circle fusion evaluation')

    self.parser.add_argument('--config', default=None,
                           help='path to additional yaml file')
