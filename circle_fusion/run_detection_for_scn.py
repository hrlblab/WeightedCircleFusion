...
def test_if_fuse(demo_scn, demo_dir, opt):
    ...
    if opt.circle_fusion:
        ...
        for model_file in model_files:
            ...
            #merge result
            run_external_script('/data/CircleNet/circle_fusion/merge_xml.py', demo_dir=opt.demo_dir)
    ...
    if opt.circle_fusion_eval:
        run_external_script('/data/CircleNet/circle_fusion/eval_xml.py', demo_dir=opt.demo_dir, gt_dir=opt.gt_dir)
